...
%----------------------------------------------------------------------------------------
% Packages and commands added later by me (not in the original template)
...
\thesistitle{Visionneuse améliorée de modèle SIG 3D} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
%\hypersetup{hidelinks} % See https://tex.stackexchange.com/a/50754/160548 for color configuration
}
...
\shipout\null % empty page without header/footer and not counted in total pages, see https://tex.stackexchange.com/a/340072/160548
